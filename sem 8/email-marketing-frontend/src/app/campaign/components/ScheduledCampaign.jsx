...
const ScheduledCampaign = () => {
  ...
  useEffect(() => {
    setLoading(true);
    authAxios
      .get(`/campaign/get-all-scheduled-campaigns?page=${currentPage}`)
      .then((res) => {
          ...
          >
            ...
            <div className="mt-5 flex flex-col justify-between flex-1">
              <div className="flex items-center gap-2">
                ...
                {/* Scheduled pill */}
                <span className="px-2 py-[2px] text-[10px] font-medium rounded-full border bg-primary text-white border-primary">
                  scheduled
                </span>
              </div>

              {/* No edit button for scheduled */}
